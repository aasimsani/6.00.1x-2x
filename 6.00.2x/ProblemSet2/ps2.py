...
class RectangularRoom(object):
    ...
    def isPositionInRoom(self, pos):
        ...
        if x < self.width and x >= 0.00 and y < self.height and y >= 0.00:
            return True
        else:
            return False
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        if self.room.isPositionInRoom(old_position) == True and self.room.isPositionInRoom(new_position) == True :
            self.position = new_position
            self.room.cleanTileAtPosition(self.position)


        elif self.room.isPositionInRoom(old_position) == True and self.room.isPositionInRoom(new_position) == False:
...
#print "Standard: ", runSimulation(3, 1.0, 10, 10, 1, 30, StandardRobot)
